- [ ] 체크 박스가 있는 요소는 [x]한 항목만 적용하라.
- 정의한 스타일에 **Tailwindcss** 기능을 사용하여 Shadcn Components **창의적**으로 디자인하여 표현하라.
...
위 선택한 요소에 맞게 다음 기법을 조합하여 입체감을 표현한다.
